...
public class AuthorListController {
    ...
    private Predicate<AuthorTable> createPredicate(String searchText) {
        return author -> {
            ...
            return (author.getName() + " " + author.getLastName()).toLowerCase().contains(searchText.toLowerCase());
        };
    }
    ...
    public void initialize() {
        ...
        FilteredList<AuthorTable> filteredData = new FilteredList<>(FXCollections.observableArrayList(authorsList));
